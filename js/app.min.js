...
app.commands = app.commands || {}, function() {
    app.commands.help = {
        ...
        run: function(a) {
            ...
            var b = "------------\nCommands\n------------\n", c = "Other:\n";
            for (command in app.commands) if ("run" in app.commands[command]) c += "	" + command + ": " + app.commands[command].help(!0) + "\n"; else {
                b += command + ":\n";
                for (subcommand in app.commands[command]) b += "	" + subcommand + ": " + app.commands[command][subcommand].help(!0) + "\n";
            }
