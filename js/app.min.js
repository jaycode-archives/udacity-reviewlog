...
!function() {
    app.viewModel = function() {
        self = this, self.report = new app.Report(), self.shrinkConsole = function() {
...
function() {
    app.commands.reviews.list_reviews = {
        ...
        run: function(a, b) {
            ...
            return app.data.reviews.length = 0, app.vm.report._totalEarnings(0), app.vm.report.totalReviews(0), 
            app.vm.report._totalTimeSpent(0), app.vm.report._avgHourlyEarnings(0), i.onsuccess = function() {
                var a = i.result;
                if (a) {
                    ...
                    app.data.reviews.push({
                        ...
                        link: '<a target="_blank" href="https://review.udacity.com/#!/reviews/' + a.value.id + '">' + a.value.id + "</a>",
                        notes: ""
                    }), app.vm.report._totalEarnings(app.vm.report._totalEarnings() + parseFloat(a.value.price)), 
                    app.vm.report.totalReviews(app.vm.report.totalReviews() + 1), app.vm.report._totalTimeSpent(app.vm.report._totalTimeSpent() + d), 
                    app.vm.report._avgHourlyEarnings(app.vm.report._totalEarnings() / (app.vm.report._totalTimeSpent() / 60)), 
                    a["continue"]();
                } else console.log(null);
            }, c.oncomplete = function() {
                $.fn.dataTable.isDataTable("#review-list-table") ? $("#review-list-table").DataTable() : $("#review-list-table").dataTable({
...
!function() {
    ...
    if (0 == a.length) {
        var d = new Date();
        b = new Date(d.getFullYear() + " " + (d.getMonth() + 1)), c = new Date(d.getFullYear() + yearsFromMonths(normalizeMonth(d.getMonth() + 2)) + " " + normalizeMonth(d.getMonth() + 2));
    } else if (2 == a.length) b = new Date(a[0] + " " + a[1]), c = new Date(b.getFullYear() + yearsFromMonths(normalizeMonth(b.getMonth() + 2)) + " " + normalizeMonth(b.getMonth() + 2)); else if (4 == a.length) var b = new Date(a[0] + " " + a[1]), c = new Date(a[2] + " " + a[3]); else {
