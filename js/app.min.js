...
function() {
    app.commands.reviews.list_reviews = {
        ...
        run: function(a, b) {
            ...
            return app.vm.reviews.removeAll(), app.vm.report.totalEarnings(0), app.vm.report.totalReviews(0), 
            i.onsuccess = function() {
                var a = i.result;
                if (a) {
                    var b = a.value.assigned_at, c = a.value.completed_at, d = 60 * c.getHours() + c.getMinutes() - 60 * b.getHours() + b.getMinutes();
                    app.vm.reviews.push({
                        project_name: a.value.project.name,
                        date: b.toLocaleDateString("en-GB", {
                            day: "numeric",
                        ...
                        link: '<a target="_blank" href="https://review.udacity.com/#!/reviews/' + a.value.id + '">' + a.value.id + "</a>",
                        notes: ""
                    }), app.vm.report.totalEarnings(app.vm.report._totalEarnings() + parseFloat(a.value.price)), 
                    app.vm.report.totalReviews(app.vm.report.totalReviews() + 1), a["continue"]();
                } else console.log(null);
            }, app.showPage("#review-list"), "Loading list page...";
        }
    };
...
!function() {
    app.Report = function(a) {
        ...
        b.totalReviews = ko.observable(0), b._totalEarnings = ko.observable(0), b.totalEarnings = ko.computed({
            ...
            write: function(a) {
                b._totalEarnings(parseNumberWithSeparators(a));
            }
        });
    };
}();