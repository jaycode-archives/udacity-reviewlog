    ...
    app.commands.reviews.list_reviews = {
        ...
        run: function(a, b) {
            ...
            return i.onsuccess = function() {
                var a = i.result;
                if (a) {
                    var b = a.value.assigned_at, c = a.value.completed_at, d = (c.getTime() - b.getTime()) / 1e3 / 60, e = a.value.archive_url;
                    e && "" != e || (e = a.value.url), app.data.reviews.push({
                        id: "",
                        ...
                        price: a.value.price,
                        reference: '<a target="_blank" href="' + e + '">' + a.value.user.name + "(version??)</a>",
