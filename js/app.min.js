...
function() {
    app.commands.reviews.list_reviews = {
        ...
        run: function(a, b) {
            ...
            app.vm.report._totalTimeSpent(0), app.vm.report._avgHourlyEarnings(0), app.vm.reviewListMonth(g.getDate() + " " + monthString(g.getMonth() + 1) + g.getFullYear() + " to " + h.getDate() + " " + monthString(h.getMonth() + 1) + h.getFullYear());
            var j = 0, k = 0, l = 0, m = 0;
            return i.onsuccess = function() {
                ...
                if (a) {
                    ...
                    app.data.reviews.push({
                        ...
                        link: '<a target="_blank" href="https://review.udacity.com/#!/reviews/' + a.value.id + '">' + a.value.id + "</a>",
                        notes: ""
                    }), j += parseFloat(a.value.price), k += 1, l += d, m = j / (l / 60), a["continue"]();
                } else console.log(null);
            }, c.oncomplete = function() {
                app.vm.report._totalEarnings(j), app.vm.report.totalReviews(k), app.vm.report._totalTimeSpent(l), 
                app.vm.report._avgHourlyEarnings(m), $.fn.dataTable.isDataTable("#review-list-table") ? $("#review-list-table").dataTable().api().clear().rows.add(app.data.reviews).draw() : $("#review-list-table").dataTable({
...
!function() {
    ...
    } else if (2 == a.length) b = new Date(a[0] + " " + a[1]), c = new Date(b.getFullYear() + yearsFromMonths(b.getMonth() + 2) + " " + normalizeMonth(b.getMonth() + 2)); else if (4 == a.length) var b = new Date(a[0] + " " + a[1]), c = new Date(a[2] + " " + a[3]); else {
