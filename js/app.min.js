...
!function() {
    ...
    } else if (2 == a.length) b = new Date(a[0] + " " + a[1]), c = new Date(b.getFullYear() + yearsFromMonths(normalizeMonth(b.getMonth() + 2)) + " " + normalizeMonth(b.getMonth() + 2)); else {
        if (4 != a.length) throw new Error("Invalid number of arguments (should be 0, 2, or 4");
        var d = new Date(a[0] + " " + a[1]);
        b = new Date(d.getFullYear() + " " + (d.getMonth() + 1));
