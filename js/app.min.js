    ...
    app.commands.reviews.pull_reviews = {
        ...
        run: function(args, terminal) {
            if (localStorage.udacity_api) {
                var batch = [], months = 3;
                if (1 == args.length && (months = args[0] + 1), args.length <= 1) var endDate = new Date(), startMonth = normalizeMonth(endDate.getMonth() + 2 - months), startYear = endDate.getFullYear() + yearsFromMonths(endDate.getMonth() + 1 - months), startDate = new Date(startYear + " " + startMonth); else var startDate = new Date(args[0] + " " + args[1]), endDate = new Date(args[1] + " " + args[2]);
