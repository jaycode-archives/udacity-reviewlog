    ...
    app.commands.reviews.pull_reviews = {
        ...
        run: function(a, b) {
            if (localStorage.udacity_api) {
                var c = [], d = 3;
                if (1 == a.length && (d = parseInt(a[0])), a.length <= 1) var e = new Date(), f = normalizeMonth(e.getMonth() + 2 - d), g = e.getFullYear() + yearsFromMonths(e.getMonth() + 1 - d), h = new Date(g + " " + f); else var h = new Date(a[0] + " " + a[1]), e = new Date(a[1] + " " + a[2]);
