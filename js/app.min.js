...
!function() {
    app.viewModel = function() {
        self = this, self.reviews = ko.observableArray([]), self.report = new app.Report(), 
...
function() {
    app.commands.reviews.list_reviews = {
        ...
        run: function(a, b) {
            ...
            return app.vm.reviews.removeAll(), app.vm.report._totalEarnings(0), app.vm.report.totalReviews(0), 
